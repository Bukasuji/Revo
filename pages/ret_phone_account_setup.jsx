            ...
            <div className="flex justify-center h-[700px]">
                <div>
                    ...
                    <div className="mt-[90px] flex justify-center">
                            <Link  href="/comm_sign_up" className="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </div>    
...
export default ret_phone_account_setup
