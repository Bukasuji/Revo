            ...
            <div className="flex justify-center h-[700px]">
                ...
                <form>
                    ...
                    <div className="mt-[90px] flex justify-center">
                            <Link  href="/ret_phone_account_setup" className="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </div>    
...
export default ret_phone_location
