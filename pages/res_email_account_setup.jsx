            ...
            <div className="flex justify-center h-[700px]">
                <div>
                    ...
                    <div className="mt-[90px] flex justify-center">
                            <Link  href="/res_phone_form" className="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </div>    
...
export default res_email_account_setup
