...
const ret_phone_code = () => {
    return (
        <div className="min-h-screen bg-white overflow-hidden">
           ...
           <p className="ml-8 mt-3">Code sent to 0803****90. This code will expire in 01:00sec</p>
            ...
            <div className="flex justify-center h-[600px] mt-10">
                <form>
                    ...
                    <div className="mt-[322px] flex justify-center">
                            <Link  href="/ret_phone_success" class="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </form>    
