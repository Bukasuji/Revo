            ...
            <div className="flex justify-center h-[600px] mt-10">
                <form>
                    ...
                    <div className="mt-[322px] flex justify-center">
                            <Link  href="/com_email_success" class="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </form>    
