                ...
                <div className="w-full">
                   ...
                   <div className="flex justify-center">
                    ...
                    <div className="mt-[180px] flex justify-center">
                            <Link  href="/res_phone_account_setup" class="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Account Setup
                            </Link>      
                    </div>
                </div>  
...
export default res_phone_success
