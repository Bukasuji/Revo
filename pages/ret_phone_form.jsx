            ...
            <div className="flex justify-center h-[600px]">
                <form>
                    <div className="px-[15px] py-[15px] w-96 drop-shadow-2xl bg-[#FFFFFF] rounded-3xl">
                            ...
                            <div className="mt-[20px] shadow-xl  rounded-full">
                                <input class="shadow appearance-none border rounded-2xl w-full bg-[#FFFFFF] py-4 px-3 text-grey-800 leading-tight focus:outline-none focus:shadow-outline" id="BusinessName" type="text" placeholder="Shop name"/>
                            </div>
                    ...
                    <div className="mt-[78px] flex justify-center">
                            <Link  href="/ret_phone_code" class="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </form>    
