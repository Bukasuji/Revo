                ...
                <div className="w-full">
                   ...
                   <div className="flex justify-center">
                    ...
                    <div className="mt-[180px] flex justify-center">
                            <Link  href="/com_phone_location" class="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Account Setup
                            </Link>      
                    </div>
                </div>  
...
export default com_phone_success
