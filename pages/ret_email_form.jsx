            ...
            <div className="flex justify-center h-[600px]">
                <form>
                    ...
                    <div className="mt-[78px] flex justify-center">
                            <Link  href="/ret_email_code" class="bg-[#F55B14] hover:bg-[#dc5112] text-white font-bold py-[18px] px-[62px] rounded">
                                        Next
                            </Link>      
                    </div>
                </form>    
